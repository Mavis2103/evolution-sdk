...
const tx = await client
  ...
  .payToAddress({
    ...
    assets: {
      lovelace: 2000000n,
      "7edb7a2d9fbc4d2a68e4c9e9d3d7a5c8f2d1e9f8a7b6c5d4e3f2a1b0c9d8e7f6": 100n
    }
  })
  .build();
...
// ---cut---
const recipientAddress = "addr_test1vrm9x2dgvdau8vckj4duc89m638t8djmluqw5pdrFollw8qd9k63";
