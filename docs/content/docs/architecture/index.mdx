...
stateDiagram-v2
  ...
  MinimalClient --> ReadClient: withProvider()
  MinimalClient --> AddressClient: withAddress()
  MinimalClient --> OfflineSignerClient: withSigner()
    
  ReadClient --> ReadOnlyClient: withAddress()
  ReadClient --> SigningClient: withSigner()
  AddressClient --> ReadOnlyClient: withProvider()
  OfflineSignerClient --> SigningClient: withProvider()
