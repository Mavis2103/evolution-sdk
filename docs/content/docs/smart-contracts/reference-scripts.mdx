...
```typescript twoslash
import { Address, Assets, blockfrost, createClient, preprod, seedWallet } from "@evolution-sdk/evolution"
...
const client = createClient({
  ...
  wallet: seedWallet({ mnemonic: process.env.WALLET_MNEMONIC!, accountIndex: 0 })
})
...
```typescript twoslash
import { Address, Data, blockfrost, createClient, preprod, seedWallet, type UTxO } from "@evolution-sdk/evolution"
...
```typescript twoslash
import { Data, blockfrost, createClient, preprod, seedWallet, type UTxO } from "@evolution-sdk/evolution"
