...
const tx = await client
  ...
  .payToAddress({
    ...
    datum: { type: "inline", value: Data.constr(0n, []) }
  })
  .build()
...
const tx = await client
  ...
  .payToAddress({
    address: scriptAddress,
    assets,
    datum: { type: "inline", value: Data.constr(0n, [100n]) }
  })
  .build()
...
const tx = await client
  ...
  .payToAddress({
    ...
    assets: Assets.fromLovelace(10_000_000n),
    datum: { type: "inline", value: Data.constr(0n, [1735689600000n]) }
  })
  .payToAddress({
    address: vestingAddress,
    assets: Assets.fromLovelace(50_000_000n),
    datum: { type: "inline", value: Data.constr(0n, [1735776000000n, 5000000n]) }
  })
  .build()
