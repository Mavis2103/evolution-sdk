...
import * as GovernanceAction from "../governance/GovernanceAction.js"
...
import * as AuxiliaryDataHash from "../metadata/AuxiliaryDataHash.js"
import * as NetworkId from "../network/NetworkId.js"
...
import * as PositiveCoin from "../value/PositiveCoin.js"
...
export const FromCDDL = Schema.transformOrFail(CDDLSchema, Schema.typeSchema(TransactionBody), {
  ...
  decode: (fromA) =>
    E.gen(function* () {
      ...
      const certificatesRaw = fromA.get(4n) as
